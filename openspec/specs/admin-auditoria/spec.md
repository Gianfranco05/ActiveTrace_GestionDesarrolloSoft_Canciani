...
## Purpose
Panel de auditoria frontend: metricas de uso del sistema, log completo de acciones con filtros y paginacion. Vista para usuarios con permiso `auditoria:ver`.
