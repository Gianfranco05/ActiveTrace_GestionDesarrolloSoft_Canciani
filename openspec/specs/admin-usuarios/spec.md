...
## Purpose
Frontend de gestion de usuarios del tenant: listado con filtros, alta, edicion y activacion/desactivacion. Vista para usuarios con permiso `usuarios:gestionar`.
