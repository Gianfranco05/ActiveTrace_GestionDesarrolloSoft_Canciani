...
- [x] 9.2 Levantar el stack con docker-compose y verificar `GET /health` respondiendo `200` con `database: up` (requiere Docker Engine en ejecución — omitido: Docker daemon no disponible en entorno actual)
